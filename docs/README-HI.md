...
Kiri Store एक स्वतंत्र ओपन-सोर्स प्रोजेक्ट है जो GitHub, Inc. से संबद्ध नहीं है।  
...
> [!IMPORTANT]
> **macOS उपयोगकर्ता:** आपको एक चेतावनी दिख सकती है कि Apple, Kiri Store को सत्यापित नहीं कर सकता। ऐसा इसलिए होता है क्योंकि ऐप App Store के बाहर वितरित की जाती है और अभी तक notarized नहीं है। System Settings → Privacy & Security → Open Anyway के ज़रिए इसे अनुमति दें।
...
- **ऐप प्रबंधन**
    - इंस्टॉल किए गए ऐप्स को Kiri Store से सीधे खोलें, अनइंस्टॉल करें और डाउनग्रेड करें।
...
## 🔍 मेरी ऐप Kiri Store में कैसे दिखेगी?

Kiri Store किसी भी निजी इंडेक्सिंग या मैन्युअल क्यूरेशन नियमों का उपयोग नहीं करता।  
...
2. **नवीनतम रिलीज़ में इंस्टॉल योग्य फ़ाइलें**
    ...
    - Kiri Store GitHub के स्वचालित रूप से जनरेट किए गए सोर्स आर्काइव (`Source code (zip)` / `Source code (tar.gz)`) को अनदेखा करता है।
...
यदि आपकी रिपॉजिटरी इन शर्तों को पूरा करती है, तो Kiri Store इसे सर्च के माध्यम से खोज सकता है और स्वचालित रूप से दिखा सकता है — किसी मैन्युअल सबमिशन की आवश्यकता नहीं।

---

## ✅ फ़ायदे / Kiri Store क्यों उपयोग करें?
...
- **जानता है कि आपने क्या इंस्टॉल किया है**
  Kiri Store (Android) के माध्यम से इंस्टॉल किए गए ऐप्स को ट्रैक करता है और जब नई रिलीज़ उपलब्ध होती हैं तो हाइलाइट करता है, ताकि आप GitHub पर दोबारा खोजे बिना उन्हें अपडेट कर सकें।
...
## 🔐 Kiri Store APK साइनिंग सर्टिफ़िकेट

सभी आधिकारिक Kiri Store रिलीज़ निम्नलिखित सर्टिफ़िकेट फ़िंगरप्रिंट के साथ साइन की जाती हैं:
...
| फ़ील्ड                         | मान                                             |
| ------------------------------ | ----------------------------------------------- |
| **Application name**           | कुछ भी (जैसे *Kiri Store Dev*)               |
...
Kiri Store एक हाई स्कूल छात्र द्वारा बनाया और मेंटेन किया जाता है। आपका सपोर्ट उन्हें इसमें मदद करता है:
...
Kiri Store केवल तृतीय-पक्ष डेवलपर्स द्वारा GitHub पर पहले से प्रकाशित रिलीज़ फ़ाइलों को खोजने और डाउनलोड करने में आपकी मदद करता है।  
...
Kiri Store का उपयोग करके, आप समझते और स्वीकार करते हैं कि आप किसी भी डाउनलोड किए गए सॉफ़्टवेयर को अपने जोखिम पर इंस्टॉल और चलाते हैं।  
