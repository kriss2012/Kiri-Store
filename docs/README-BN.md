...
প্রায়শই জিজ্ঞাসিত প্রশ্ন ও দরকারী তথ্যের জন্য Kiri Store [উইকি](https://github.com/kriss2012/Kiri-Store/wiki) দেখুন

💬 **WhatsApp:** [কমিউনিটিতে যোগ দিন](https://chat.whatsapp.com/EXAMPLE_LINK)
...
Kiri Store একটি স্বাধীন, ওপেন-সোর্স প্রকল্প যা GitHub, Inc.-এর সাথে সম্পর্কিত নয়।  
...
> [!IMPORTANT]
> **macOS ব্যবহারকারীরা:** আপনি একটি সতর্কতা দেখতে পারেন যে Apple Kiri Store যাচাই করতে পারছে না। এটি ঘটে কারণ অ্যাপটি App Store-এর বাইরে বিতরণ করা হয় এবং এখনো নোটারাইজড নয়। System Settings → Privacy & Security → Open Anyway-এর মাধ্যমে এটি অনুমতি দিন।
...
- **অ্যাপ ম্যানেজমেন্ট**
    - Kiri Store থেকে সরাসরি ইনস্টল করা অ্যাপ খুলুন, আনইনস্টল করুন এবং ডাউনগ্রেড করুন।
...
## 🔍 আমার অ্যাপ Kiri Store-এ কীভাবে দেখা যাবে?

Kiri Store কোনো ব্যক্তিগত ইন্ডেক্সিং বা ম্যানুয়াল কিউরেশন নিয়ম ব্যবহার করে না।  
...
2. **সর্বশেষ রিলিজে ইনস্টলযোগ্য অ্যাসেট**
    ...
    - Kiri Store স্বয়ংক্রিয়ভাবে তৈরি সোর্স আর্টিফ্যাক্ট (`Source code (zip)` /
...
আপনার রিপোজিটরি এই শর্তগুলো পূরণ করলে, Kiri Store সার্চের মাধ্যমে এটি খুঁজে পেতে এবং স্বয়ংক্রিয়ভাবে দেখাতে পারে — কোনো ম্যানুয়াল সাবমিশনের প্রয়োজন নেই।

---

## ✅ সুবিধা / কেন Kiri Store ব্যবহার করবেন?
...
- **আপনি কী ইনস্টল করেছেন তা জানে**
  Kiri Store (Android) দিয়ে ইনস্টল করা অ্যাপ ট্র্যাক করে এবং নতুন রিলিজ পাওয়া গেলে হাইলাইট করে, যাতে আপনাকে আবার GitHub-এ খুঁজতে না হয়।
...
## 🔐 Kiri Store APK সাইনিং সার্টিফিকেট

সব অফিসিয়াল Kiri Store রিলিজ নিচের সার্টিফিকেট ফিঙ্গারপ্রিন্ট দিয়ে স্বাক্ষরিত:
...
| ফিল্ড                          | মান                                         |
| ------------------------------ | ------------------------------------------- |
| **Application name**           | যা খুশি (যেমন *Kiri Store Dev*)           |
...
Kiri Store একজন হাই স্কুল ছাত্র দ্বারা তৈরি ও রক্ষণাবেক্ষণ করা হয়। আপনার সাপোর্ট তাকে সাহায্য করে:
...
- ⭐ **এই রিপোতে স্টার দিন** — অন্যদের Kiri Store আবিষ্কার করতে সাহায্য করে
- 🐛 **বাগ রিপোর্ট করুন** — সবার জন্য অ্যাপটি আরও ভালো করে
- 📢 **বন্ধুদের সাথে শেয়ার করুন** — অন্য ডেভেলপার ও পরিচিতদের মধ্যে ছড়িয়ে দিন!
- 💬 **আমাদের [Discord](https://chat.whatsapp.com/EXAMPLE_LINK)-এ যোগ দিন** — আপনার মতামত রোডম্যাপ তৈরি করে
...
Kiri Store শুধুমাত্র GitHub-এ তৃতীয় পক্ষের ডেভেলপারদের দ্বারা ইতোমধ্যে প্রকাশিত রিলিজ অ্যাসেট আবিষ্কার ও ডাউনলোড করতে সাহায্য করে।  
সেই ডাউনলোডগুলোর বিষয়বস্তু, নিরাপত্তা ও আচরণ সম্পূর্ণরূপে তাদের নিজস্ব লেখক ও বিতরণকারীদের দায়িত্ব, এই প্রকল্পের নয়।

Kiri Store ব্যবহার করে, আপনি বুঝতে ও সম্মত হন যে আপনি নিজের ঝুঁকিতে যেকোনো ডাউনলোড করা সফটওয়্যার ইনস্টল ও চালু করছেন।  
...
Kiri Store **Apache License, Version 2.0**-এর অধীনে প্রকাশিত হবে।
