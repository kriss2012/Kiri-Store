...
Обратитесь к [Вики](https://github.com/kriss2012/Kiri-Store/wiki) Kiri Store для часто задаваемых вопросов и полезной информации

💬 **WhatsApp:** [Присоединяйтесь к сообществу](https://chat.whatsapp.com/EXAMPLE_LINK)
...
Kiri Store — это независимый проект с открытым исходным кодом, не связанный с GitHub, Inc.  
...
> [!IMPORTANT]
> **Пользователи macOS:** Вы можете увидеть предупреждение о том, что Apple не может проверить Kiri Store. Это происходит потому, что приложение распространяется за пределами App Store и ещё не нотаризовано. Разрешите его через Системные настройки → Конфиденциальность и безопасность → Всё равно открыть.
...
- **Управление приложениями**
    - Открывайте, удаляйте и откатывайте версии установленных приложений прямо из Kiri Store.
...
## 🔍 Как моё приложение появится в Kiri Store?

Kiri Store не использует никакой частной индексации или ручных правил курирования.  
...
2. **Устанавливаемые файлы в последнем релизе**
    ...
    - Kiri Store игнорирует автоматически сгенерированные архивы исходного кода (`Source code (zip)` /
      `Source code (tar.gz)`).
...
Если ваш репозиторий соответствует этим условиям, Kiri Store может найти его через поиск и отобразить
автоматически, без необходимости ручной подачи заявки.

---

## ✅ Преимущества / Зачем использовать Kiri Store?
...
- **Знает, что вы установили**
  Отслеживает приложения, установленные через Kiri Store (Android), и уведомляет о наличии новых релизов, чтобы вы могли обновиться без повторного поиска на GitHub.
...
## 🔐 Сертификат подписи APK Kiri Store

Все официальные релизы Kiri Store подписаны следующим отпечатком сертификата:
...
| Поле                           | Значение                                    |
| ------------------------------ | ------------------------------------------- |
| **Application name**           | Любое на ваш выбор (напр. *Kiri Store Dev*) |
...
Kiri Store создан и поддерживается старшеклассником. Ваша поддержка помогает ему:
...
- ⭐ **Поставив звезду этому репозиторию** — помогает другим открыть для себя Kiri Store
- 🐛 **Сообщая об ошибках** — улучшает приложение для всех
- 📢 **Поделившись с друзьями** — расскажите другим разработчикам и знакомым!
- 💬 **Присоединившись к нашему [Discord](https://chat.whatsapp.com/EXAMPLE_LINK)** — ваши отзывы формируют план развития
...
Kiri Store лишь помогает вам находить и скачивать файлы релизов, которые уже опубликованы на
...
Используя Kiri Store, вы понимаете и соглашаетесь с тем, что устанавливаете и запускаете любое загруженное
...
Kiri Store распространяется под **Лицензией Apache, Версия 2.0**.
