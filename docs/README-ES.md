...
Consulta la [Wiki](https://github.com/kriss2012/Kiri-Store/wiki) de Kiri Store para preguntas frecuentes e informacion util

💬 **WhatsApp:** [Unete a la comunidad](https://chat.whatsapp.com/EXAMPLE_LINK)
...
Kiri Store es un proyecto independiente de codigo abierto, no afiliado a GitHub, Inc.  
...
> [!IMPORTANT]
> **Usuarios de macOS:** Es posible que veas una advertencia indicando que Apple no puede verificar Kiri Store. Esto ocurre porque la aplicacion se distribuye fuera del App Store y aun no esta notarizada. Permitela a traves de Ajustes del Sistema → Privacidad y Seguridad → Abrir de todos modos.
...
<strong>HelloGitHub:</strong> <a href="https://hellogithub.com/en/repository/kriss2012/Kiri-Store">Proyecto Destacado</a>
</p>
...
- **Gestion de aplicaciones**
    - Abre, desinstala y degrada aplicaciones instaladas directamente desde Kiri Store.
...
## 🔍 ¿Como aparece mi aplicacion en Kiri Store?

Kiri Store no utiliza ningun tipo de indexacion privada ni reglas de curacion manual.  
...
2. **Archivos instalables en el ultimo release**
    ...
    - Kiri Store ignora los artefactos de codigo fuente generados automaticamente (`Source code (zip)` /
      `Source code (tar.gz)`).
...
Si tu repositorio cumple estas condiciones, Kiri Store puede encontrarlo a traves de la busqueda y mostrarlo
automaticamente, sin necesidad de envio manual.

---

## ✅ Ventajas / ¿Por que usar Kiri Store?
...
- **Sabe lo que instalaste**
  Rastrea las apps instaladas a traves de Kiri Store (Android) y destaca cuando hay nuevas releases disponibles, para que puedas actualizarlas sin buscar de nuevo en GitHub.
...
## 🔐 Certificado de Firma del APK de Kiri Store

Todas las releases oficiales de Kiri Store estan firmadas con la siguiente huella digital del certificado:
...
| Campo                          | Valor                                       |
| ------------------------------ | ------------------------------------------- |
| **Application name**           | Lo que prefieras (p.ej. *Kiri Store Dev*) |
...
Kiri Store esta construido y mantenido por un estudiante de instituto. Tu apoyo le ayuda a:
...
- ⭐ **Dando una estrella a este repositorio** — ayuda a otros a descubrir Kiri Store
...
- 💬 **Uniendote a nuestro [Discord](https://chat.whatsapp.com/EXAMPLE_LINK)** — tus comentarios moldean la hoja de ruta
...
Kiri Store solo te ayuda a descubrir y descargar archivos de releases que ya estan publicados en
...
Al usar Kiri Store, entiendes y aceptas que instalas y ejecutas cualquier software descargado
...
Kiri Store se distribuira bajo la **Licencia Apache, Version 2.0**.
