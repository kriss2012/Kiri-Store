...
Kiri Store è uno store di applicazioni multipiattaforma per le release di GitHub, progettato per semplificare la scoperta e l'installazione di software open source. Rileva automaticamente i binari installabili (APK, EXE, DMG, AppImage, DEB, RPM), offre l'installazione con un solo clic, traccia gli aggiornamenti e presenta le informazioni sui repository in un'interfaccia pulita in stile app store.
...
Consulta la [Wiki](https://github.com/kriss2012/Kiri-Store/wiki) di Kiri Store per le FAQ e informazioni utili

💬 **WhatsApp:** [Unisciti alla community](https://chat.whatsapp.com/EXAMPLE_LINK)
...
Kiri Store è un progetto open source indipendente, non affiliato a GitHub, Inc.  
...
> [!IMPORTANT]
> **Utenti macOS:** Potresti vedere un avviso che indica che Apple non riesce a verificare Kiri Store. Ciò accade perché l'app è distribuita al di fuori dell'App Store e non è ancora notarizzata. Consentila tramite Impostazioni di Sistema → Privacy e Sicurezza → Apri comunque.
...
<strong>HelloGitHub:</strong> <a href="https://hellogithub.com/en/repository/kriss2012/Kiri-Store">Progetto in Evidenza</a>
</p>
...
- **Gestione delle applicazioni**
    - Apri, disinstalla e declassa le app installate direttamente da Kiri Store.
...
## 🔍 Come appare la mia app su Kiri Store?

Kiri Store non utilizza alcun sistema di indicizzazione privato né regole di curazione manuale.  
...
2. **File installabili nell'ultima release**
    ...
    - Kiri Store ignora gli archivi del codice sorgente generati automaticamente (`Source code (zip)` / `Source code (tar.gz)`).
...
Se il tuo repository soddisfa queste condizioni, Kiri Store può trovarlo tramite la ricerca e mostrarlo automaticamente — nessuna submission manuale richiesta.

---

## ✅ Vantaggi / Perché usare Kiri Store?
...
- **Sa cosa hai installato**
  Traccia le app installate tramite Kiri Store (Android) e segnala quando sono disponibili nuove release, così puoi aggiornarle senza dover tornare a cercare su GitHub.
...
## 🔐 Certificato di Firma APK di Kiri Store

Tutte le release ufficiali di Kiri Store sono firmate con la seguente impronta digitale del certificato:
...
| Campo                          | Valore                                          |
| ------------------------------ | ----------------------------------------------- |
| **Application name**           | Quello che preferisci (es. *Kiri Store Dev*)  |
...
Kiri Store è sviluppato e mantenuto da uno studente liceale. Il tuo supporto lo aiuta a:
...
- ⭐ **Mettendo una stella a questo repository** — aiuta gli altri a scoprire Kiri Store
- 🐛 **Segnalando bug** — migliora l'app per tutti
- 📢 **Condividendo con gli amici** — spargi la voce tra altri sviluppatori e amici!
- 💬 **Unendoti al nostro [Discord](https://chat.whatsapp.com/EXAMPLE_LINK)** — il tuo feedback plasma la roadmap
...
Kiri Store ti aiuta soltanto a scoprire e scaricare file di release già pubblicati su GitHub da sviluppatori terzi.  
...
Usando Kiri Store, capisci e accetti che installi ed esegui qualsiasi software scaricato a tuo rischio e pericolo.  
...
Kiri Store sarà rilasciato sotto la **Licenza Apache, Versione 2.0**.
