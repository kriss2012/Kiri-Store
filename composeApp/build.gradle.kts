...
val isAndroidDisabled = findProperty("kiristore.disableAndroid")?.toString()?.toBoolean() ?: false
...
compose.desktop {
    application {
        mainClass = "zed.rainxch.kiristore.DesktopAppKt"
        nativeDistributions {
            packageName = "Kiri-Store"
            packageVersion =
                    ...
                    extraKeysRawXml =
                        ...
                        <array>
                            <dict>
                                ...
                                <string>Kiri Store Deep Link</string>
                                <key>CFBundleURLSchemes</key>
                                <array>
                                    <string>kiristore</string>
                                </array>
                            </dict>
                        </array>
                        """.trimIndent()
