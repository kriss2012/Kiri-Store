package zed.rainxch.kiristore.app
...
class KiriStoreApp : Application() {
    ...
    override fun onCreate() {
        ...
        initKoin {
            androidContext(this@KiriStoreApp)
        }
    ...
    private fun registerSelfAsInstalledApp() {
        appScope.launch {
            try {
                ...
                if (systemInfo == null) {
                    Logger.w { "KiriStoreApp: Skip self-registration, package info missing for $selfPackageName" }
                    return@launch
                }
                ...
                Logger.i("Kiri Store App: App added")
            } catch (e: Exception) {
                Logger.e(e) { "Kiri Store App: Failed to register self as installed app" }
            }
        }
    }
