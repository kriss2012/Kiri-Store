...
class DesktopFileLocationsProvider(
        ...
        val baseDir =
            when (platform) {
                Platform.WINDOWS -> {
                    ...
                    File(appData, "KiriStore\\Downloads")
                }

                Platform.MACOS -> {
                    val home = System.getProperty("user.home")
                    File(home, "Library/Caches/KiriStore/Downloads")
                }
                ...
                Platform.LINUX -> {
                    ...
                    File(cacheHome, "KiriStore/downloads")
                }

                else -> {
                    File(System.getProperty("user.home"), ".KiriStore/downloads")
                }
            }
    ...
    override fun userDownloadsDir(): String {
        val appSubdirName = "Kiri Store Downloads"
        val downloadsDir =
            when (platform) {
                Platform.WINDOWS -> {
                    val userProfile =
